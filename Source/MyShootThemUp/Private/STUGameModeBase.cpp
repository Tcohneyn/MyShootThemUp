...
void ASTUGameModeBase::SpawnBots()
{
    ...
    for (int32 i = 0; i < GameData.PlayersNum - 1; i++)
    {
        ...
        const auto STUAICharater = GetWorld()->SpawnActor<AAIController>(AIControllerClass, SpawnInfo);
        RestartPlayer(STUAICharater);
    }
}
...
void ASTUGameModeBase::Killed(AController* KillController, AController* VictimController)
{
    const auto KillerPlayerState = KillController ? Cast<ASTUPlayerState>(KillController->PlayerState) : nullptr;
